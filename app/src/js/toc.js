...
function htmlTableOfContents(documentRef) {
  ...
  // Index damit einzelne TOC Zeilen �ber CSS ansprechbar sind (untersuchbar in Browser).
  headings.forEach(function(heading, index) {
    ...
    // TextContent (standard) statt innerText produziert Abst�nde, Grund unbekannt
